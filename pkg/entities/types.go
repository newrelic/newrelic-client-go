...
// AiNotificationsCategory - Category fields to group by
type AiNotificationsCategory string

var AiNotificationsCategoryTypes = struct {
	// Condition category
	CONDITION AiNotificationsCategory
	// Entities category
	ENTITIES AiNotificationsCategory
	// Incident category
	INCIDENT AiNotificationsCategory
	// Issue category
	ISSUE AiNotificationsCategory
	// Default category
	OTHER AiNotificationsCategory
	// Policy category
	POLICY AiNotificationsCategory
	// Tags category
	TAGS AiNotificationsCategory
	// Workflow category
	WORKFLOW AiNotificationsCategory
}{
	// Condition category
	CONDITION: "CONDITION",
	// Entities category
...
// EntityDeleteErrorType - List of all potential error types that an entity delete operation might return.
type EntityDeleteErrorType string

var EntityDeleteErrorTypeTypes = struct {
	// Forbidden request
	FORBIDDEN EntityDeleteErrorType
	// Internal error
	INTERNAL_ERROR EntityDeleteErrorType
	// Invalid input
	INVALID_INPUT EntityDeleteErrorType
}{
	// Forbidden request
	FORBIDDEN: "FORBIDDEN",
	// Internal error
...
type AiNotificationsVariable struct {
	...
	Active bool `json:"active"`
	// Variable category
	Category AiNotificationsCategory `json:"category"`
...
type ChangeTrackingSearchFilter struct {
	...
	// Search time window.
	TimeWindow TimeWindowInput `json:"timeWindow,omitempty"`
}
...
// EntityDeleteError - Type that wraps the errors from a entity delete operation.
type EntityDeleteError struct {
	...
	Type EntityDeleteErrorType `json:"type"`
}

// EntityDeleteResult - Response type for delete operations over entities.
type EntityDeleteResult struct {
	// List that contains the guids of the deleted entities
	DeletedEntities []common.EntityGUID `json:"deletedEntities"`
	// List of failures for the delete operation.
	Failures []EntityDeleteError `json:"failures"`
}

...
type EntityManagementComponentEntity struct {
	// To filter stream of data coming from Vortex events to fetch impacted accounts based on data sources.
	DataSources []string `json:"dataSources"`
	// The component description.
	Description string `json:"description,omitempty"`
	// The entity's global unique identifier.
	ID string `json:"id"`
	// To filter stream of data coming from Vortex events to fetch impacted accounts based on data types.
	IngestDataTypes []string `json:"ingestDataTypes"`
	// List of associated internal services names with this component.
	InternalServiceNames []string `json:"internalServiceNames"`
	// True if the component is publicly accessible.
...
type EntityManagementCustomerImpactEntity struct {
	...
	Impact []EntityManagementImpact `json:"impact"`
	// Metadata about the entity.
	Metadata EntityManagementMetadata `json:"metadata"`
...
// EntityManagementImpact - Impact represents the impacted component and its attributes.
type EntityManagementImpact struct {
	// Impacted attribute.
	ImpactedAttribute1 []EntityManagementImpactAttribute `json:"impactedAttribute1"`
	// Impacted attribute.
	ImpactedAttribute2 []EntityManagementImpactAttribute `json:"impactedAttribute2"`
	// Impacted attribute.
	ImpactedAttribute3 []EntityManagementImpactAttribute `json:"impactedAttribute3"`
	// Impacted component.
	ImpactedComponent EntityManagementComponentEntity `json:"impactedComponent"`
}

// EntityManagementImpactAttribute - ImpactAttribute represents the impacted attribute of a component. An attribute can be an account, customer, or any other entity that is impacted by the incident.
type EntityManagementImpactAttribute struct {
	// The impacted attribute value.
	Blob EntityManagementBlob `json:"blob"`
	// Identifies the kind of impacted attribute. Ex: AccountIds, customerNames.
...
type EntityManagementMaintenanceWindowEntity struct {
	// The cron expression representing the schedule of the maintenance window.
	CronExpression string `json:"cronExpression,omitempty"`
	// The description of the maintenance window.
	Description string `json:"description,omitempty"`
	// The entity's global unique identifier.
	ID string `json:"id"`
	// The duration of the maintenance window in ISO8601 formatted string.
	MaintenanceDuration Duration `json:"maintenanceDuration"`
	// The end date of maintenance period
	MaintenancePeriodEndDate *nrtime.EpochMilliseconds `json:"maintenancePeriodEndDate,omitempty"`
	// The start date of maintenance period
	MaintenancePeriodStartDate *nrtime.EpochMilliseconds `json:"maintenancePeriodStartDate"`
	// Metadata about the entity.
	Metadata EntityManagementMetadata `json:"metadata"`
	// The name of this entity.
	Name string `json:"name"`
	// The next occurrence end time of the maintenance window.
	NextOccurrenceEnd *nrtime.EpochMilliseconds `json:"nextOccurrenceEnd,omitempty"`
	// The next occurrence start time of the maintenance window.
	NextOccurrenceStart *nrtime.EpochMilliseconds `json:"nextOccurrenceStart,omitempty"`
	// The entity's scope.
	Scope EntityManagementScopedReference `json:"scope"`
	// Collection of tags.
	Tags []EntityManagementTag `json:"tags"`
...
type EntityManagementNotebookEntity struct {
	...
	Config EntityManagementBlob `json:"config,omitempty"`
	// The entity's global unique identifier.
	ID string `json:"id"`
	// Metadata about the entity.
	Metadata EntityManagementMetadata `json:"metadata"`
...
type EntityManagementPipelineCloudRuleEntity struct {
	...
	Description string `json:"pipelineRuleDescription,omitempty"`
	// The entity's global unique identifier.
	ID string `json:"id"`
	// Metadata about the entity.
	Metadata EntityManagementMetadata `json:"metadata"`
...
// EntityManagementSecretReference - Secret reference type for all connections

...
// DashboardOwnerType - Specifies the type of entity that owns a dashboard.
type DashboardOwnerType string

var DashboardOwnerTypeTypes = struct {
	// A non-human system principal identified by a UUID.
	SYSTEM_IDENTITY DashboardOwnerType
	// A human user identified by a numeric New Relic user ID.
	USER DashboardOwnerType
}{
	// A non-human system principal identified by a UUID.
	SYSTEM_IDENTITY: "SYSTEM_IDENTITY",
	// A human user identified by a numeric New Relic user ID.
...
type DashboardOwnerInfo struct {
	...
	Email string `json:"email,omitempty"`
	// Stringified principal ID. For USER type this is the numeric user ID; for SYSTEM_IDENTITY this is a UUID.
	ID string `json:"id,omitempty"`
	// Owner type: USER or SYSTEM_IDENTITY
	Type DashboardOwnerType `json:"type,omitempty"`
	// New Relic user ID.
	UserID int `json:"userId,omitempty"`
}
...
type EntityManagementActorStitchedFields struct {
	...
	CollectionElements EntityManagementCollectionElementsResult `json:"collectionElements,omitempty"`
	// Retrieves the collections containing the given entity.
	CollectionsContainingEntity []EntityManagementCollectionsContainingEntityResult `json:"collectionsContainingEntity,omitempty"`
	// Retrieves an entity.
...
// EntityManagementCollectionElementsResult - The result of a collection elements query.
type EntityManagementCollectionElementsResult struct {
	// The current page of results.
	Items []EntityManagementEntityInterface `json:"items"`
	// Cursor pointing to the next page of results.
	NextCursor string `json:"nextCursor,omitempty"`
}

// special
func (x *EntityManagementCollectionElementsResult) UnmarshalJSON(b []byte) error {
	var objMap map[string]*json.RawMessage
	err := json.Unmarshal(b, &objMap)
	if err != nil {
		return err
	...
	for k, v := range objMap {
		...
		case "items":
			...
			var rawMessageItems []*json.RawMessage
			err = json.Unmarshal(*v, &rawMessageItems)
			if err != nil {
				return err
			}
...
// EntityManagementCollectionEntityCreateInput - Create input for CollectionEntity entity type.
type EntityManagementCollectionEntityCreateInput struct {
	// See name in CollectionEntity.
	Name string `json:"name"`
	// See scope in CollectionEntity.
...
// EntityManagementCollectionEntityCreateResult - The result of creating an entity.
type EntityManagementCollectionEntityCreateResult struct {
	// The created entity.
	Entity EntityManagementCollectionEntity `json:"entity"`
}

// EntityManagementCollectionEntityUpdateInput - Update input for CollectionEntity entity type.
type EntityManagementCollectionEntityUpdateInput struct {
	// See name in CollectionEntity.
	Name string `json:"name,omitempty"`
	// See tags in CollectionEntity.
	Tags []EntityManagementTagInput `json:"tags,omitempty"`
...
type EntityManagementCollectionEntityUpdateResult struct {
	// The updated entity.
	Entity EntityManagementCollectionEntity `json:"entity"`
}

// EntityManagementCollectionsContainingEntityResult - The result of a collectionsContainingEntity query.
type EntityManagementCollectionsContainingEntityResult struct {
	// The collection entity.
	Collection EntityManagementCollectionEntity `json:"collection"`
	// The location of the collection in its parent entity, if any.
	ParentInfo EntityManagementParentInfo `json:"parentInfo,omitempty"`
}
...
// EntityManagementDiscoverySettingsUpdateInput - Update input for DiscoverySettings.
type EntityManagementDiscoverySettingsUpdateInput struct {
	// See enabled in DiscoverySettings.
	Enabled bool `json:"enabled"`
	// See tagKeys in DiscoverySettings.
	TagKeys []string `json:"tagKeys"`
}
...
// EntityManagementNRQLRuleEngineCreateInput - Create input for NrqlRuleEngine.
type EntityManagementNRQLRuleEngineCreateInput struct {
	// See accounts in NrqlRuleEngine.
	Accounts []int `json:"accounts"`
	// See joinAccounts in NrqlRuleEngine.
	JoinAccounts []int `json:"joinAccounts"`
	// See query in NrqlRuleEngine.
	Query string `json:"query"`
}

// EntityManagementNRQLRuleEngineUpdateInput - Update input for NrqlRuleEngine.
type EntityManagementNRQLRuleEngineUpdateInput struct {
	// See accounts in NrqlRuleEngine.
	Accounts []int `json:"accounts"`
	// See joinAccounts in NrqlRuleEngine.
	JoinAccounts []int `json:"joinAccounts"`
...
// EntityManagementParentInfo - The location of a collection within a parent entity.
type EntityManagementParentInfo struct {
	// The collection's parent entity.
	ParentEntity EntityManagementEntityInterface `json:"parentEntity"`
	// The field containing the collection in the parent entity.
	ParentField string `json:"parentField"`
}

// special
func (x *EntityManagementParentInfo) UnmarshalJSON(b []byte) error {
	var objMap map[string]*json.RawMessage
	err := json.Unmarshal(b, &objMap)
	if err != nil {
		return err
	...
	for k, v := range objMap {
		...
		case "parentField":
			err = json.Unmarshal(*v, &x.ParentField)
			if err != nil {
				return err
			}
		}
...
type EntityManagementPipelineControlConfiguration struct {
	...
	Fleet EntityManagementFleetEntity `json:"fleet,omitempty"`
...
// EntityManagementProgressLevelDefinitionCreateInput - Create input for ProgressLevelDefinition.
type EntityManagementProgressLevelDefinitionCreateInput struct {
	// See description in ProgressLevelDefinition.
	Description string `json:"description,omitempty"`
	// See hexColorCode in ProgressLevelDefinition.
	HexColorCode string `json:"hexColorCode,omitempty"`
	// See id in ProgressLevelDefinition.
	ID string `json:"id"`
	// See name in ProgressLevelDefinition.
	Name string `json:"name"`
}

// EntityManagementProgressLevelDefinitionUpdateInput - Update input for ProgressLevelDefinition.
type EntityManagementProgressLevelDefinitionUpdateInput struct {
	// See description in ProgressLevelDefinition.
	Description string `json:"description,omitempty"`
	// See hexColorCode in ProgressLevelDefinition.
	HexColorCode string `json:"hexColorCode,omitempty"`
...
// EntityManagementScheduleCreateInput - Create input for Schedule.
type EntityManagementScheduleCreateInput struct {
	...
	Period int `json:"period,omitempty"`
	// See rrule in Schedule.
	Rrule string `json:"rrule,omitempty"`
	// See scheduleAt in Schedule.
	ScheduleAt nrtime.DateTime `json:"scheduleAt,omitempty"`
	// See timezone in Schedule.
	Timezone string `json:"timezone,omitempty"`
}
...
// EntityManagementScorecardEntityCreateInput - Create input for ScorecardEntity entity type.
type EntityManagementScorecardEntityCreateInput struct {
	// See description in ScorecardEntity.
	Description string `json:"description,omitempty"`
	// See name in ScorecardEntity.
	Name string `json:"name"`
	// See progressLevels in ScorecardEntity.
	ProgressLevels []EntityManagementProgressLevelDefinitionCreateInput `json:"progressLevels,omitempty"`
	// See scope in ScorecardEntity.
	Scope EntityManagementScopedReferenceInput `json:"scope,omitempty"`
	// See tags in ScorecardEntity.
	Tags []EntityManagementTagInput `json:"tags,omitempty"`
}

// EntityManagementScorecardEntityCreateResult - The result of creating an entity.
type EntityManagementScorecardEntityCreateResult struct {
	// The created entity.
	Entity EntityManagementScorecardEntity `json:"entity"`
}
...
type EntityManagementScorecardEntityUpdateResult struct {
	// The updated entity.
	Entity EntityManagementScorecardEntity `json:"entity"`
}
...
// EntityManagementScorecardRuleEntityCreateInput - Create input for ScorecardRuleEntity entity type.
type EntityManagementScorecardRuleEntityCreateInput struct {
	...
	NRQLEngine *EntityManagementNRQLRuleEngineCreateInput `json:"nrqlEngine,omitempty"`
	// See name in ScorecardRuleEntity.
	Name string `json:"name"`
	// See progressLevel in ScorecardRuleEntity.
	ProgressLevel string `json:"progressLevel,omitempty"`
	// See runInterval in ScorecardRuleEntity.
	RunInterval int `json:"runInterval,omitempty"`
	// See schedule in ScorecardRuleEntity.
	Schedule *EntityManagementScheduleCreateInput `json:"schedule,omitempty"`
	// See scope in ScorecardRuleEntity.
	Scope EntityManagementScopedReferenceInput `json:"scope,omitempty"`
	// See tags in ScorecardRuleEntity.
	Tags []EntityManagementTagInput `json:"tags,omitempty"`
}

// EntityManagementScorecardRuleEntityCreateResult - The result of creating an entity.
type EntityManagementScorecardRuleEntityCreateResult struct {
	// The created entity.
	Entity EntityManagementScorecardRuleEntity `json:"entity"`
}
...
type EntityManagementScorecardRuleEntityUpdateInput struct {
	...
	ImpactWeight int `json:"impactWeight,omitempty"`
	// See nrqlEngine in ScorecardRuleEntity.
	NRQLEngine *EntityManagementNRQLRuleEngineUpdateInput `json:"nrqlEngine,omitempty"`
	// See name in ScorecardRuleEntity.
	Name string `json:"name,omitempty"`
	// See progressLevel in ScorecardRuleEntity.
	ProgressLevel string `json:"progressLevel,omitempty"`
...
type EntityManagementScorecardRuleEntityUpdateResult struct {
	// The updated entity.
	Entity EntityManagementScorecardRuleEntity `json:"entity"`
}
...
// EntityManagementSyncGroupRuleConditionUpdateInput - Update input for SyncGroupRuleCondition.
type EntityManagementSyncGroupRuleConditionUpdateInput struct {
	// See type in SyncGroupRuleCondition.
	Type EntityManagementSyncGroupRuleConditionType `json:"type"`
	// See value in SyncGroupRuleCondition.
	Value string `json:"value"`
}

// EntityManagementSyncGroupRuleUpdateInput - Update input for SyncGroupRule.
type EntityManagementSyncGroupRuleUpdateInput struct {
	// See conditions in SyncGroupRule.
	Conditions []EntityManagementSyncGroupRuleConditionUpdateInput `json:"conditions,omitempty"`
}
...
// EntityManagementSyncGroupsSettingsUpdateInput - Update input for SyncGroupsSettings.
type EntityManagementSyncGroupsSettingsUpdateInput struct {
...
type EntityManagementTeamEntityCreateInput struct {
	...
	Resources []EntityManagementTeamResourceCreateInput `json:"resources,omitempty"`
	// See scope in TeamEntity.
	Scope EntityManagementScopedReferenceInput `json:"scope,omitempty"`
	// See tags in TeamEntity.
	Tags []EntityManagementTagInput `json:"tags,omitempty"`
}

// EntityManagementTeamEntityCreateResult - The result of creating an entity.
type EntityManagementTeamEntityCreateResult struct {
	// The created entity.
	Entity EntityManagementTeamEntity `json:"entity"`
}
...
type EntityManagementTeamEntityUpdateResult struct {
	// The updated entity.
	Entity EntityManagementTeamEntity `json:"entity"`
}
...
// EntityManagementTeamExternalIntegrationCreateInput - Create input for TeamExternalIntegration.
type EntityManagementTeamExternalIntegrationCreateInput struct {
	// See externalId in TeamExternalIntegration.
	ExternalId string `json:"externalId"`
	// See type in TeamExternalIntegration.
	Type EntityManagementTeamExternalIntegrationType `json:"type,omitempty"`
}

// EntityManagementTeamExternalIntegrationUpdateInput - Update input for TeamExternalIntegration.
type EntityManagementTeamExternalIntegrationUpdateInput struct {
	// See externalId in TeamExternalIntegration.
	ExternalId string `json:"externalId"`
	// See type in TeamExternalIntegration.
	Type EntityManagementTeamExternalIntegrationType `json:"type,omitempty"`
...
// EntityManagementTeamResourceCreateInput - Create input for TeamResource.
type EntityManagementTeamResourceCreateInput struct {
	// See content in TeamResource.
	Content string `json:"content"`
	// See title in TeamResource.
	Title string `json:"title,omitempty"`
	// See type in TeamResource.
	Type string `json:"type"`
}

// EntityManagementTeamResourceUpdateInput - Update input for TeamResource.
type EntityManagementTeamResourceUpdateInput struct {
	// See content in TeamResource.
	Content string `json:"content"`
	// See title in TeamResource.
	Title string `json:"title,omitempty"`
...
// EntityManagementTeamsHierarchyLevelEntityUpdateInput - Update input for TeamsHierarchyLevelEntity entity type.
type EntityManagementTeamsHierarchyLevelEntityUpdateInput struct {
...
type EntityManagementTeamsHierarchyLevelEntityUpdateResult struct {
	// The updated entity.
	Entity EntityManagementTeamsHierarchyLevelEntity `json:"entity"`
}
...
type EntityManagementTeamsOrganizationSettingsEntityUpdateResult struct {
	// The updated entity.
	Entity EntityManagementTeamsOrganizationSettingsEntity `json:"entity"`
}
...
type collectionElementsResponse struct {
	Actor Actor `json:"actor"`
}

type collectionsContainingEntityResponse struct {
	Actor Actor `json:"actor"`
}

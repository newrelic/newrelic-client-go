...
// Force vulnerable dependencies to use fixed versions
replace (
	github.com/anchore/quill => github.com/anchore/quill v0.5.1
	...
	github.com/theupdateframework/go-tuf/v2 => github.com/theupdateframework/go-tuf/v2 v2.4.1
